...
msbuild SDL2-2.0.3\VisualC\SDL_VS2010.sln /p:configuration=Debug /t:Clean;SDL2 /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
msbuild SDL2-2.0.3\VisualC\SDL_VS2010.sln /p:configuration=Debug /t:SDL2main /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
...
msbuild SDL2-2.0.3\VisualC\SDL_VS2010.sln /p:configuration=Release /t:Clean;SDL2 /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
msbuild SDL2-2.0.3\VisualC\SDL_VS2010.sln /p:configuration=Release /t:SDL2main /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
