...
msbuild pixman-0.30.0\pixman\pixman100\pixman.sln /p:configuration=Debug /t:Clean;Build /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
...
msbuild SDL2-2.0.0\VisualC\SDL_VS2010.sln /p:configuration=Debug /t:Clean;SDL2 /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
msbuild SDL2-2.0.0\VisualC\SDL_VS2010.sln /p:configuration=Debug /t:Clean;SDL2main /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
...
msbuild pixman-0.30.0\pixman\pixman100\pixman.sln /p:configuration=Release /t:Clean;Build /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
...
msbuild SDL2-2.0.0\VisualC\SDL_VS2010.sln /p:configuration=Release /t:Clean;SDL2 /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
msbuild SDL2-2.0.0\VisualC\SDL_VS2010.sln /p:configuration=Release /t:Clean;SDL2main /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
