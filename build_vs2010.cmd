...
msbuild pixman-0.30.0\pixman\pixman100\pixman.sln /p:configuration=Debug /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
...
msbuild pixman-0.30.0\pixman\pixman100\pixman.sln /p:configuration=Release /p:PlatformToolset=%TARGETTOOLSET% || goto :EOF
